$(function() {
	...
	// Get the form Consultations.
	var form = $('#consultations-form');
	...
	$(form).submit(function(e) {
		...
		if(isvalid)
        {
	        ...
	        var jqxhr = $.post(url, formData, function(data) {
				...
				$(formMessages).text('Oops! Ocurrió un error y su consulta no fue registrada. Por favor intenténtelo nuevamente.');
	        });
	    }
	});
